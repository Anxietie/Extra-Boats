...
public class ExtraChestBoatEntity extends ExtraBoatEntity implements RideableInventory, VehicleInventory {
    ...
    public ExtraChestBoatEntity(EntityType<? extends ExtraBoatEntity> entityType, World world) {
        super(entityType, world);
    }

    public ExtraChestBoatEntity(World world, double d, double e, double f) {
        this(EntityRegister.EXTRA_CHEST_BOAT, world);
    ...
    @Override
    public Item asItem() {
        if (this.getVariant() == WARPED) return ItemRegister.WARPED_CHEST_BOAT;
        return ItemRegister.CRIMSON_CHEST_BOAT;
    }
